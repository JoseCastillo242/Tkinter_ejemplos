...
tasas_conversion = {
    'USD': {'EUR': 0.85, 'GBP': 0.74, 'JYP': 110.17},
    'EUR': {'USD': 1.18, 'GBP': 0.88, 'JYP': 129.55},
    'GBP': {'USD': 1.36, 'EUR': 1.14, 'JYP': 147.85},
    'JYP': {'USD': 0.0091, 'EUR': 0.0077, 'GBP': 0.0068}
}
...
def calcular_conversion():
    ...
    if divisa_origen != divisa_destino:
        ...
        etiqueta_resultado.config(text="Las divisas de origen y de destino deben ser diferentes")

#crear la ventana principal
ventana = tk.Tk()
ventana.title("Calculadora de divisas")

#crear etiquetas y colocarlas en una cuadricula
...
# Crear combo para seleccionar las divisas de origen y destino
